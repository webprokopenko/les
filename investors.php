        ...
        <div class="page__container">
            <div class="page__row clearfix">
                <ul class="breadcrumbs list">
                    ...
                    <li class="list__item breadcrumbs__item">
                        Технологии - <b>Поиск инвестора</b>
                    </li>
                </ul>
            </div>
    ...
    <div class="popup_add_prog" id="modal_technology_sale">
        <div class="popup_prog_header">
            ...
            <div class="prog_header_text">
                Добавить объявление о поиске инвестора
            </div>
        </div>
        <div class="popup_prog_body">
            <div class="popup__msg">
            </div>
            <form action="../../ajax/ajax_add_investors.php" class="form"  id="market_investors_send"  method="post" enctype="multipart/form-data">
                <label for="company" class="prog_span">Компания: <b><?=$investors->getCompany($_SESSION['user_id']);?></b></label>
                ...
                <textarea name="opisanie"  id="opisanie" rows="4" class="input h_a" placeholder="Описание (кого вы ищете, для каких целей,сумма денег которая Вам необходима)" qtip-position="left" qtip-content="Вы не ввели описание"></textarea>
                <input type="hidden" name="token" id="token" value="<?=$investors::token()?>"/>
                <div class="prog_row">
...
<script src="js/add_investors.js"></script>
<script>
