...
require_once('class/class.partners.php');
...
<?php if($_SESSION['user_id']):?>
    ...
    <div class="popup_add_prog" id="modal_technology_sale">
        ...
        <div class="popup_prog_body">
            ...
            <form action="../../ajax/ajax_add_partners.php" class="form"  id="market_partners_send"  method="post" enctype="multipart/form-data">
                <label for="company" class="prog_span">Компания: <b><?=$partners->getCompany($_SESSION['user_id']);?></b></label>
                ...
                <input type="hidden" name="token" id="token" value="<?=$partners::token()?>"/>
                <div class="prog_row">
