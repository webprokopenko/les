<aside class="sidebar sidebar_position_left">
        ...
        <ul class="list catalog-nav">
            <li class="list__item catalog-nav__item">
                ...
                <ul id="main_ul" class="list catalog-nav catalog-nav__subnav catalog-nav__subnav_opened">
                    ...
                    <li class="list__item catalog-nav__item catalog-nav__subnav-item"><a href="#" class="catalog-nav__link catalog-nav__subnav-link">Цена компании</a></li>
                    <li class="list__item catalog-nav__item catalog-nav__subnav-item"><a href="#" class="catalog-nav__link catalog-nav__subnav-link">Рекомендации</a></li>
                </ul>
            </li>
            <li class="list__item catalog-nav__item">
            ...
            <li class="list__item catalog-nav__item">
                <a href="#" class="catalog-nav__trigger catalog-nav__link">О нас</a>
                <ul class="list catalog-nav catalog-nav__subnav">
