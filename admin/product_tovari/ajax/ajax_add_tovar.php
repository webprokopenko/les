...
$query="INSERT INTO product_tovari(name_product, category_f_k, price, col_vo, country_proish, data_actuality) VALUES('$name_product', '$category_f_k', '$price', '$col_vo', '1', '$data_actuality')";
