...
<head>
                        ...
                        <? else: ?>
                            <div class="add_obj">
                                <a href="#" id="add_technology" class="add_obj-item">
                                    Добавить объявление о покупке технологий<br>
                                </a>
                            </div>
                        <?php endif; ?>
                        <ul class="catalog catalog_style_grid list">
                            <?=$technology->getBodyTechnology(1)?>
                        </ul>
                    </section>
                </main>
    ...
    <?php if($_SESSION['user_id']):?>
        ...
        <div class="popup_add_prog" id="modal_technology_buy">
            ...
            <div class="popup_prog_body">
                ...
                <form action="../../ajax/ajax_add_technology_buy.php" class="form"  id="market_technology_send"  method="post" enctype="multipart/form-data">
    ...
    <script src="js/add_technology_buy.js"></script>
    <script>
